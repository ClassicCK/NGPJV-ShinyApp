             ...
             sidebarLayout(
               sidebarPanel(
                 ...
                 div(style = "display: flex; justify-content: space-around; align-items: center; margin-bottom: 20px;",
                     img(src = "https://www.birdconservancy.org/wp-content/uploads/2015/04/bcr-logo-retina-sm.png", height = "64px"),
                     img(src = "https://ngpjv.org/wp-content/uploads/2023/01/ngpjv-logo.png", height = "64px"),
                     img(src = "https://weconservepa.org/wp-content/uploads/2023/03/NFWF-logo.png", height = "64px")
                 )
               ),
